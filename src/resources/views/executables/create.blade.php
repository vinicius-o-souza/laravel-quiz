        ...
        <div class="box box-primary">
            <div class="box-body">
                ...
                <div id="questionnaire_form_block">
                    ...
                    {!! Form::open(['route' => ['executables.store', request()->config('pandoapps::models.parent_name_singular')], 'class' => 'w-100', 'id' => 'questionnaire_form']) !!}
                        ...
                        <div class="row p-md-5">
                            ...
                            <div class="form-group col-sm-12 pt-5">
                                ...
                                <a href="{!! route('executables.index', ['parent_id' => request()->config('pandoapps::models.parent_name_singular'), 'questionnaire_id' => $questionnaire->id]) !!}" class="btn btn-default">Cancelar</a>
                            </div>
                        </div>
                    {!! Form::close() !!}
                </div>            
...
@push('scripts_quiz')
    ...
    <script type="text/javascript">
        ...
        $(document).on("click", "#start_button", function() {
            ...
            $.ajax({
                url:'{!! route("executables.start", request()->config('pandoapps::models.parent_name_singular')) !!}',
                data:{
                    "_token": "{{ csrf_token() }}",
